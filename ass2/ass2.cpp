...
int main() {
    ...
    cout << "bst1 number of nodes: " << bst1.getNumberOfNodes() << endl;
    bst1.displaySideways();
    cout << ((bst1 != bst2) ? "OK" : "ERR") << ": bst1 != bst2" << endl;
    bst2.add("g");
    bst2.add("d");
    bst2.add("k");
    cout << "bst2 height: " << bst2.getHeight() << endl;
    cout << "bst2 number of nodes: " << bst2.getNumberOfNodes() << endl;
    ...
    BinarySearchTree<string> bst5("binary");
    bst5.add("search");
    bst5.add("tree");
    cout << "bst5 height: " << bst5.getHeight() << endl;
    cout << "bst5 number of nodes: " << bst5.getNumberOfNodes() << endl;
